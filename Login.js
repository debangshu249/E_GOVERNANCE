  ...
  return (
    <div className="loginScreen">
      <div className="loginBoxNew">
        ...
        {/* PUBLIC: ONLY Web3 wallet (No email/password fields) */}
        {userType === "public" && (
          <div className="loginFormNew" style={{ padding: "20px 0", textAlign: "center" }}>
            
            <p style={{ color: '#666', marginBottom: '20px', fontSize: '14px' }}>
              A Web3 login fee of <strong>0.0001 ETH</strong> is required to verify your identity.
            </p>
            ...
            {web3Status && (
              <p style={{ marginTop: "15px", fontSize: "14px", color: "#0056b3", fontWeight: "bold" }}>
                {web3Status}
              </p>
            )}

            <div style={{ marginTop: "20px" }}>
              <span style={{ color: "#666", fontSize: "14px" }}>New here? </span>
              <button type="button" className="textLinkBtn" onClick={onSignup} style={{ padding: 0 }}>
                Sign Up
              </button>
            </div>
          </div>
